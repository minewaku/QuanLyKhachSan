...
public class OrdersGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					if (tfReservationId.getText().trim().equals("") || tfServiceId.getText().trim().equals("") || tfQuantity.getText().trim().equals(""))
						...
						lblError.setText(orderBUS.editOrders(em, em.getReservationId(), em.getServiceId()));
						loadOrderList();
						loadReservationList();
						loadServiceList();
					}	
        ...
        deleteBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					if (tfReservationId.getText().trim().equals("") || tfServiceId.getText().trim().equals(""))
						lblError.setText("Vui lòng nhập đủ thông tin");
        		...
        		.addGroup(jPanel2Layout.createSequentialGroup()
        			...
        			.addGroup(jPanel2Layout.createParallelGroup(Alignment.LEADING)
        				...
        				.addGroup(jPanel2Layout.createSequentialGroup()
        					...
        					.addGap(7)
        					.addComponent(tfReservationId, GroupLayout.DEFAULT_SIZE, 162, Short.MAX_VALUE))
